...
// use : node firstDatas.js 'mongodb url'

console.log('This script populates some test books, authors, genres and bookinstances to the database. Specified database as argument - e.g.: populatedb mongodb+srv://cooluser:coolpassword@cluster0.a9azn.mongodb.net/local_library?retryWrites=true');
...
function createGenreAuthors(cb) {
    async.series([
        function(callback) {
          authorCreate('Titouan', 'LEBOCQ', '1973-06-06', false, callback);
        },
        function(callback) {
          authorCreate('Paul', 'GOUBARD', '1932-11-8', false, callback);
        },
        function(callback) {
          authorCreate('Antoine', 'GUESPIN', '1920-01-02', '1992-04-06', callback);
        },
        function(callback) {
          authorCreate('Jesus', 'Billings', false, false, callback);
        },
        function(callback) {
          authorCreate('ThisIs', 'aTest', '1971-12-16', false, callback);
        },
        function(callback) {
...
function createBooks(cb) {
    async.parallel([
        ...
        function(callback) {
            bookCreate('Dragon Ball', 'The story of a young ninja who wants to become the pirate king', '66666666666666', authors[4], genres[3], callback)
          }
        ],
        // optional callback
        cb);
...
function createBookInstances(cb) {
    async.parallel([
        ...
        function(callback) {
            bookInstanceCreate(books[7], 'Jump force', false, false, callback)
          },
        function(callback) {
